...
|---|---|---|
| 1 | At a Glance | 155.6K requests, 88 countries, human vs bot donut (62%/38%), busiest days bar, top 10 countries, 4 insight cards |
...
| 5 | Who Are The Visitors? | 4.0K unique IPs, browser breakdown (IE 49K, Firefox 23K), device types (Desktop 59K, Bot 12K), OS split, visit frequency, top 10 IPs |
...
| External location | `raw-logs` | ABFSS path `abfss://raw-logs@stw3cetlwestus3.dfs.core.windows.net/` - read-only access for Auto Loader |
